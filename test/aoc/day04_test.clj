...
(def eventstring "[1518-10-05 00:10] falls asleep")
...
(deftest can-split-event-from-string-test
  (testing "should result in { :date \"1518-10-05 00:10\" :event [ \"falls\" \"asleep\" ] }"
    (is (= { :date "1518-10-05 00:10" :event [ "falls" "asleep" ] } (create-event eventstring)))))

(deftest can-sort-events-test
  (testing "should result in sorted list"
    (is (= "1518-07-06 00:55" ((first (sort-events (map-events eventstrings))) :date)))))